...
message = JSON.parse(message); 
  ...
  if (msg == 'token') {
	...
	var dest = 'Q'+ q_no.toString() + '-R' + r_no.toString();
	  ...
	  //    new Buffer( blob.replace(/^data:audio\/mp3;base64,/, "").replace(/^data:video\/webm;base64,/, ""), 'binary' ).toString('base64');  
	  //var binaryData = new Buffer( blob.replace(/^data:audio\/mp3;base64,/, "").replace(/^data:video\/webm;base64,/, ""), 'binary' )
