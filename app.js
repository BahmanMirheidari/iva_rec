        ...
        try {
            ...
            if (msg != null) {
                ...
                if (msg == 'consent') {
                    ...
                    common.process_webmvideoaudio(config.mount_dir, logger,updateconversation,data, __dirname,'video',500000000,180,false); 
                }
                else if (msg == 'audio'){
                    common.process_webmvideoaudio(config.mount_dir, logger,updateconversation,data, __dirname,'audio',60000000,180,false); 
                }
                else if (msg == 'token')  {
