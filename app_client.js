...
function mount(mnt, callback){
  var command = 'echo ' + pass.SAMBA.pwd + ' | sudo -s mount -t cifs ' + pass.SAMBA.address + ' ' + mnt + ' -o username=' + pass.SAMBA.username + ',password='+ pass.SAMBA.password + ',rw,file_mode=0750,dir_mode=0750,uid=' + pass.SAMBA.uid;
